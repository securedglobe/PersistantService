...
*/
#include "stdafx.h"
#include "SG_RevealerService.h"
#pragma comment(lib, "wevtapi.lib")


#define BUFFER_SIZE				1024
#define DATETIME_BUFFER_SIZE	80
#define SERVICE_REG_KEY			L"SOFTWARE\\SG_RevealerService"
...
* @param subkey	String value to specify exact location where key needs to be created ex. SOFTWARE\\SG_RevealerService
